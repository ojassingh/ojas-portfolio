...
const Intro = () => {
    return(
      <div id='home' className='h-screen py-20 lg:mt-20 md:mt-20 xs:mt-0 xs:px-4 xs:w-screen'>
        <div className=''>
          <motion.div whileHover={{translateY: -5}}  className='lg:px-40 md:px-10  lg:flex bg-gradient-to-r from-cyan-600 to-pink-700 text-transparent bg-clip-text brightness-175'>
        ...
        <motion.div  whileHover={{translateY: -7}}  className='ml-3 xs:ml-0 mt-10 lg:px-40 md:px-10'>
          <p className='mt-3 text-lg xs:text-md text-cyan-500 tracking-wide'>{"<div id='super-cool-description' >"}</p>
          ...
          <p className='mt-2 lg:text-lg md:text-md xs:text-md text-cyan-500 tracking-wide'>{"</div>"}</p>
        </motion.div>
