...
const Footer = () => {
    return(<div className="bg-dark py-10 px-40 grid place-content-center">
        ...
        <div className="flex text-center text-gray-500 scale-150 py-2 ml-18">
        ...
        <p className="text-gray-500 text-center">Built by Ojas Singh with ❤️</p>
        <p className="text-gray-500 text-center">All rights reserved. ©</p>
    </div>)
}
